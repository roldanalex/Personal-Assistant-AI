...
chat_response <- function(
    ...
    system_prompt = c("general", "r_code", "python_code"),
    ...
    model_selected = model) {
        ...
        req <-
            ...
            req_user_agent("Alexis Roldan @roldanalex | Personal Bot") |>
            req_body_json(body) |>
...
get_system_prompt <- function(system = c("general", "r_code", "python_code")) {

    rlang::arg_match(system)
    instructions <- switch(
        system,
        "general" = "You are an useful and resourceful assistant.",
        "r_code" = "You are a resourceful and efficient chat bot that answers questions for an R programmer.", # nolint: line_length_linter.
        "python_code" = "You are an efficient and resourceful chat bot that answers questions for an Python programmer.") # nolint: line_length_linter.
